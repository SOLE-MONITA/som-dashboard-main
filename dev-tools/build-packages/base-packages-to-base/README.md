...
- `-a`, `--app`: Set the `som-dashboard-plugins` branch.
- `-b`, `--base`: Set the `som-dashboard` branch.
- `-s`, `--security`: Set the `som-security-dashboards-plugin` branch.
- `-sa`, `--securityAnalytics`: Set the `som-dashboard-security-analytics` branch.
- `-r`, `--reporting`: Set the `som-dashboards-reporting` branch.
