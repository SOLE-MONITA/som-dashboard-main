...
2. Clone the [som-dashboard][app-repo] and the [som-security-dashboards-plugin][security-repo]
...
Once the `som-dashboard` container is up, attach a shell to it and run `yarn start --no-base-path`
...
[app-repo]: https://github.com/som/som-dashboard
[security-repo]: https://github.com/som/som-security-dashboards-plugin
