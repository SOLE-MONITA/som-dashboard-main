...
The Som dashboard Health Check plugin provides a visual interface to monitor the health status of various Som system components. It allows system administrators to quickly identify issues and verify that all services are functioning correctly.
...
- Directs you to the Som troubleshooting section
...
- Refresh the page
- Verify that Som services are running
- Check system logs
...
- Consult official Som documentation
- Contact technical support team
- Review Som community forums
