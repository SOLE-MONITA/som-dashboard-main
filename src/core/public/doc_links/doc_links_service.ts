...
export class DocLinksService {
  ...
  public start({ injectedMetadata }: StartDeps): DocLinksStart {
    ...
    const SOM_DOC_VERSION = injectedMetadata.getSomDocVersion();
    const SOM_WEBSITE_DOCS = `https://documentation.som.com/${SOM_DOC_VERSION}`;
    ...
    return deepFreeze({
      ...
      links: {
        som: {
          index: `${SOM_WEBSITE_DOCS}/index.html`,
        },
        opensearch: {
...
export interface DocLinksStart {
  ...
  readonly SOM_DOC_VERSION: string;
  readonly links: {
    readonly som: {
