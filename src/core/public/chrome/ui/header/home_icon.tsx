...
export const HomeIcon = ({ branding, logos }: Props) => {
  // Removed prop unnecessary useExpandedHeader Som dashboard
  const { applicationTitle = 'Som dashboard', useExpandedHeader } = branding;
  ...
  // If no custom branded mark was set, use `home` icon Som dashboard
