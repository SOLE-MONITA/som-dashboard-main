...
import { SOM_DOCUMENTATION_URL } from '../../constants';
  ...
  public render() {
    ...
    const defaultContent = useDefaultContent ? (
      <Fragment>
        ...
        <EuiButtonEmpty
          href="https://som.com/community/join-us-on-slack/"
          target="_blank"
          size="xs"
          flush="left"
          iconType="logoSlack"
        ...
        <EuiButtonEmpty
          href="https://groups.google.com/forum/#!forum/som/"
          target="_blank"
          size="xs"
