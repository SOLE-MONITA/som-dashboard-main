    ...
    return {
      ...
      getHeaderComponent: () => (
        <Header
          ...
          opensearchDashboardsDocLink={docLinks.links.som.index}
          ...
          opensearchDashboardsVersion={injectedMetadata.getSomVersion()}
          ...
          darkmode={uiSettings.get('theme:darkMode')} // Som
        />
      ),
